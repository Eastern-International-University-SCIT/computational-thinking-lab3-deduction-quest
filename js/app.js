...
(function () {
  ...
  const UI = {
    en: {
      ...
      languageWarning: 'From Level 3 onward, some generated premise sentences are awkwardly worded. Highlighted premises include clearer wording that preserves the same symbolic structure. Logical validity is determined from the symbolic forms.',
      languageIssueBadge: 'Wording issue detected',
      languageIssueText: 'This conditional is difficult to read because it repeats the same propositions in an OR condition and an AND result.',
      suggestedReading: 'Clearer equivalent wording',
      formalLanguageNote: 'This rewording preserves the full conditional: at least one condition being true implies that both conditions are true.',
    },
    vi: {
      ...
      languageWarning: 'Từ Mức 3, một số câu tiền đề được tạo tự động có cách diễn đạt khó hiểu. Các tiền đề được đánh dấu có cách diễn đạt rõ hơn nhưng vẫn giữ nguyên cấu trúc ký hiệu. Tính hợp lệ logic được xác định từ dạng ký hiệu.',
      languageIssueBadge: 'Đã phát hiện vấn đề diễn đạt',
      languageIssueText: 'Câu điều kiện này khó đọc vì lặp lại cùng các mệnh đề trong điều kiện HOẶC và kết quả VÀ.',
      suggestedReading: 'Cách diễn đạt tương đương rõ hơn',
      formalLanguageNote: 'Cách diễn đạt này giữ nguyên toàn bộ câu điều kiện: ít nhất một điều đúng kéo theo cả hai điều đều đúng.',
    },
  };
